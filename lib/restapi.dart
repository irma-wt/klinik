...
class DataService {
   Future insertLogin(String appid, String email, String password) async {
      String uri = 'https://api.247go.app/v5/insert/';

      try {
         final response = await http.post(Uri.parse(uri), body: {
            'token': '695bdd49045a4b3d08976ae0',
            'project': 'medic',
            'collection': 'login',
            'appid': appid,
            'email': email,
   ...
   Future insertRegister(String appid, String full_name, String email, String phone_number, String password, String confirm_password) async {
      String uri = 'https://api.247go.app/v5/insert/';
